...
def calcular_descriptores(imagen):
    ...
    promedio_valor = promedioDimensional(imagen_float)
...
def normalizarDescriptores(descriptores):
    ...
    media = np.mean(descriptores, axis=0)
...
'''
print("Promedio de los forma centroides:")
print("Centroide A:", promCentroideA.shape)
print("Centroide B:", promCentroideB.shape)
print("Centroide C:", promCentroideC.shape)
print("Centroide D:", promCentroideD.shape)
print("Centroide E:", promCentroideE.shape)
